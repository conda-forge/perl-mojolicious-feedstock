About perl-mojolicious-feedstock
================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/perl-mojolicious-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/perl-mojolicious-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add perl-mojolicious
# for installing globally
pixi global install perl-mojolicious
```
...
It is possible to list all of the versions of `perl-mojolicious` available on your platform:
...
```
pixi search perl-mojolicious --channel conda-forge
```
